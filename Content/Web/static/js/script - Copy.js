...
//});
//var images = [
//	'Content/static/images/Iphone.png',
//	'Content/static/images/laptop.png'
//];
//$(images).each(function() {
//	var image = $('<img />').attr('src', this).load(function(){
//alert('done: '+ image.attr('src'));
//		});
//});
//$('head').append( $('<link rel="stylesheet" type="text/css" />').attr('href', 'Content/static/css/style.css') );
...
if ($('#mobSlider').length) {
    ...
    var image1 = $('<img />').attr('src', 'Content/static/images/Iphone.png').load(function () {
        ...
        //$('#mobSlider').fadeIn('slow').animate({
          //  top: -200
        //}, 'slow');
        //$('.mobSliderShadow').delay(630).animate({
          //  top: 740
        //}, 'slow');
        slide('#mobSlider');
    });
